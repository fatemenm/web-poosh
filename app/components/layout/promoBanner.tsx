...
export default function PromoBanner({ data }: { data: PromoBanner }) {
  ...
  return (
    <div className="box-border flex w-full flex-col items-center bg-stone-800 py-4 text-xs font-light text-white sm:flex-row sm:justify-end sm:px-2 lg:text-sm">
